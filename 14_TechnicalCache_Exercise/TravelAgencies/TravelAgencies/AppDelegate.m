...
//    [self.dataController.travelAgencyStore closeCacheWithError:&error];
...
//    NSError* error = nil;
//    self.dataController = [TravelAgencyDataController uniqueInstance];
//    [self.dataController.travelAgencyStore reopenCacheWithKey:kCacheEncryptionKey error:&error];
...
//    self.dataController = [TravelAgencyDataController uniqueInstance];
//    [self.dataController.travelAgencyStore closeCacheWithError:&error];
//    [self.dataController.travelAgencyStore closeWithError:&error];
