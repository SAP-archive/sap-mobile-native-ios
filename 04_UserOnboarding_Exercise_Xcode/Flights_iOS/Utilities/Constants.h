...
static NSString * const kLoadServiceDocumentAndMetadataCompletedNotification = @"LoadServiceDocumentAndMetadataCompletedNotification";
static NSString * const kLoadCarrierCollectionCompletedNotification = @"LoadCarrierCollectionCompletedNotification";
static NSString * const kLoadFlightCollectionCompletedNotification = @"LoadFlightCollectionCompletedNotification";
static NSString * const kLoadFlightDetailsCompletedNotification = @"LoadFlightDetailsCompletedNotification";
static NSString * const kCreateBookingCompletedNotification = @"CreateBookingCompletedNotification";

static NSString * const kLoadTravelAgencyCollectionCompletedNotification = @"LoadTravelAgencyCollectionCompletedNotification";
static NSString * const kLoadTravelAgencyCompletedNotification = @"LoadTravelAgencyCompletedNotification";
static NSString * const kCreateTravelAgencyCompletedNotification = @"CreateTravelAgencyCompletedNotification";
static NSString * const kUpdateTravelAgencyCompletedNotification = @"UpdateTravelAgencyCompletedNotification";
static NSString * const kDeleteTravelAgencyCompletedNotification = @"DeleteTravelAgencyCompletedNotification";
static NSString * const kLoadAirportStatusCompletedNotification = @"LoadAirportStatusCompletedNotification";
