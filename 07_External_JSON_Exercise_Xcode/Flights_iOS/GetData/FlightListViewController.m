...
//// TODO: BEGIN (Navigate to the FlightDetails View)
//        
//        FlightDetailsViewController *detailViewController = [segue destinationViewController];
//        detailViewController.flight = self.flightList.entities[[self.tableView indexPathForSelectedRow].row];
//
//// TODO: END (Navigate to the FlightDetails View)
