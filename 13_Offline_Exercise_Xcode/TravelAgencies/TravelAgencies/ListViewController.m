...
- (void)viewDidLoad
{
    ...
    } else if (self.workingMode == WorkingModeOffline)
    {
        ...
        //[self.travelAgencyDataController openOfflineStore];
...
#pragma mark FlushAndRefreshData
- (IBAction)flushAndRefreshData:(id)sender {
    
//TODO: BEGIN (UNCOMMENT OFFLINE ODATA EXERCISE) ###########################################
    
//    [self.travelAgencyDataController flushAndRefreshData];
