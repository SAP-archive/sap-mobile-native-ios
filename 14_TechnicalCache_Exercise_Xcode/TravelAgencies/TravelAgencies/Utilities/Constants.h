...
#define kSmpAppID  @"smpAppID"


#pragma mark - Notifications
#define kRequestCompleted  @"RequestCompleted"



#pragma mark - Travel Agency
static NSString * const kTravelAgencyCollection = @"TravelAgencies_DQ";
...
#pragma mark cache
#define kCacheEncryptionKey @"CacheTestEncryptionKey"
